      ...
      <div className="w-full max-w-xl rounded-3xl border border-slate-100 bg-white p-8 shadow-xl sm:p-10">
        ...
        >
          ...
          <div className="flex w-full flex-1 flex-col gap-5">
            ...
            <button
              type="submit"
              className="mt-2 w-full rounded-xl bg-blue-500 px-6 py-3.5 text-sm font-bold text-white shadow-md hover:bg-teal-500 active:bg-teal-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 focus-visible:ring-offset-2 sm:text-base"
            >
              Masuk
            </button>
